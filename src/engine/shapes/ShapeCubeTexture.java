...
public class ShapeCubeTexture extends TexturedShape {
	...
	public ShapeCubeTexture(TextureInfo texture) {
		super(texture);
	}

	public ShapeCubeTexture(String texture) {
		super(texture);
	}

	@Override
	public ShapeCubeTexture copy() {
		ShapeCubeTexture shape = new ShapeCubeTexture(texture);
		return shape;
	}
