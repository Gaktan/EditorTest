...
public class ShapeQuadTexture extends TexturedShape {
	...
	public ShapeQuadTexture(TextureInfo texture) {
		super(texture);
	}

	public ShapeQuadTexture(String texture) {
		super(texture);
	}

	@Override
	public ShapeQuadTexture copy() {
		ShapeQuadTexture shape = new ShapeQuadTexture(texture);
		return shape;
	}
