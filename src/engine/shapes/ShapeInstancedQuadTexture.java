...
public class ShapeInstancedQuadTexture extends InstancedTexturedShape {
	...
	public ShapeInstancedQuadTexture(TextureInfo texture) {
		super(texture);
	}

	public ShapeInstancedQuadTexture(String texture) {
		super(texture);
	}

	@Override
	public ShapeInstancedQuadTexture copy() {
		ShapeInstancedQuadTexture shape = new ShapeInstancedQuadTexture(texture);
		return shape;
	}
